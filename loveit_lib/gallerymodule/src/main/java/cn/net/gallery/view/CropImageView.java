...
import cn.net.gallery.callback.CropBoundsChangeListener;
import cn.net.gallery.model.CropParameters;
import cn.net.gallery.model.ImageState;
import com.yalantis.ucrop.task.BitmapCropTask;
import cn.net.gallery.util.CubicEasing;
import cn.net.gallery.util.RectUtils;
...
//        float mWidthRatio=drawableWidth/mThisWidth;
//        float mHeightRatio=drawableHeight/dip2px(getContext(),350);
...
//        }
        //TODO 动态计算高度
//        float height= mThisWidth*drawableHeight/drawableWidth;

        mCropRect.set(0, 0, mThisWidth, dip2px(getContext(),350));
    ...
    private void setupInitialImagePosition(float drawableWidth, float drawableHeight) {
        ...
        //TODO 修改了默认初始化位置
//        float th = (drawableHeight-dip2px(getContext(),350)) / 2.0f + mCropRect.top;
